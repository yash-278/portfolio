...
// TODO: confirm LinkedIn URL slug before Phase 1 PR merge
const SOCIAL_LINKS = [
  {
  ...
  {
    href: 'https://linkedin.com/in/yashkadam',
    label: 'LinkedIn',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
          ...
          {SOCIAL_LINKS.map(({ href, label, icon }) => (
            <li key={href}>
              <a
                ...
                aria-label={label}
                className="text-text-muted transition-colors hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
              >
                {icon}
              </a>
            </li>
