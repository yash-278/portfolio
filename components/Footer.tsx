      ...
      <div className="mx-auto flex max-w-5xl flex-col items-start justify-between gap-4 px-6 py-8 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="flex min-h-11 min-w-11 items-center justify-center p-2 text-text-muted transition-colors duration-150 hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
            <svg
