    ...
    >
      <div className="mx-auto max-w-5xl px-6">
        ...
        <SectionReveal delay={0.1}>
          <div className="mt-10 rounded-2xl bg-surface/70 ring-1 ring-white/5 px-6 py-8 md:py-10">
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-lg bg-accent px-5 py-2.5 text-sm font-semibold text-bg transition-colors duration-150 hover:bg-accent-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
            >
              Say hello →
            </a>
            ...
            <div className="mt-8 flex items-center gap-1 pt-6">
              ...
              <div className="flex gap-1">
                <a
                  ...
                  className="flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs text-text-muted transition-colors duration-150 hover:bg-surface hover:text-accent"
                >
                  <svg
